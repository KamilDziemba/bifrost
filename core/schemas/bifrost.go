...
const (
	...
	BifrostContextKeyRedactionData                       BifrostContextKey = "bifrost-redaction-data"                           // RedactionPayload or JSON string (set by enterprise guardrails plugin - DO NOT SET THIS MANUALLY)
