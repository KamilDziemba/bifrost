...
<CardGroup cols={2}>
  ...
  <Card title="Guardrail Redaction" icon="eraser" href="/enterprise/guardrails/redaction">
    Runtime, logs-only, and reversible redaction for supported guardrail providers.
  </Card>
  <Card title="Microsoft Presidio" icon="user-shield" href="/integrations/guardrails/presidio">
...
- `runtime` redacts the live request or response and stores redacted values in logs.
...
| Capability | Presidio | Azure AI Language PII | AWS Bedrock | Azure Content Safety | Google Model Armor | CrowdStrike AIDR | GraySwan | Patronus AI |
|------------|----------|-----------------------|-------------|----------------------|--------------------|------------------|----------|-------------|
| PII Detection | Yes | Yes | Yes | No | Yes | Policy-dependent | No | Yes |
| Content Filtering | No | No | Yes | Yes | Yes | Policy-dependent | Yes | Yes |
| Prompt Injection | No | No | Yes | Yes | Yes | Policy-dependent | Yes | Yes |
| Hallucination Detection | No | No | No | No | No | No | No | Yes |
| Toxicity Screening | No | No | Yes | Yes | Yes | Policy-dependent | Yes | Yes |
| Custom Policies | Entity filters | Category filters | Yes | Yes | Yes | Policy-dependent | Yes | Yes |
| Custom Natural Language Rules | No | No | No | No | No | No | Yes | No |
| Image Support | No | No | Yes | No | No | No | No | No |
| IPI Detection | No | No | No | Yes | Yes | Policy-dependent | Yes | No |
| Mutation Detection | No | No | No | No | No | No | Yes | No |
| Bifrost-managed Redaction | Yes | Yes | No | No | No | No | No | No |
