...
export default function SecurityView() {
	...
	const handleAuthFieldChange = useCallback((field: "admin_username" | "admin_password", value: EnvVar) => {
		if (field === "admin_password") {
			const passwordPolicyFailures = !value.from_env && value.value ? getPasswordPolicyFailures(value.value) : [];
	...
	const handleSave = useCallback(async () => {
		try {
			...
			const passwordPolicyFailures =
				authConfig.is_enabled && !authConfig.admin_password?.from_env && authConfig.admin_password?.value
	...
	return (
		<div className="mx-auto w-full max-w-4xl space-y-4 h-[calc(100vh-50px)] overflow-y-auto">
			<div>
			...
			<div className="flex justify-end pt-2 sticky bottom-0 bg-card">
